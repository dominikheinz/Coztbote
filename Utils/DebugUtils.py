    ...
    class Timer:
        ...
        def stop_timer(self, function_name=""):
            ...
            if function_name in DebugUtils.timed_functions:
                ...
                DebugUtils.timed_functions[function_name][0][0] += elapsed_time * 1000.0
                DebugUtils.timed_functions[function_name][0][1] += 1
                if elapsed_time > DebugUtils.timed_functions[function_name][1]:
                    # Save max value
                    DebugUtils.timed_functions[function_name][1] = elapsed_time * 1000.0
                ...
                print('{:s} function took {:.3f} ms (Avg: {:.3f}, Max: {:.3f})'
                      .format(function_name, elapsed_time * 1000.0, avg_value, max_value))
            else:
                DebugUtils.timed_functions[function_name] = [[elapsed_time * 1000.0, 1], elapsed_time * 1000.0]
